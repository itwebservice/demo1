                ...
                <div class="search-box container">
                    ...
                    <ul class="c-search-tabs nav nav-tabs" role="tablist">
                        ...
                        <li class="nav-item">
                            ...
                            <a class="nav-link active" data-toggle="tab" href="#tours-tab" role="tab"
                                aria-controls="contact" aria-selected="false" data-service='ComboTours'>HOLIDAY</a>

                        </li>

                        <li class="nav-item">

                            <a class="nav-link" data-toggle="tab" href="#group_tour-tab" role="tab"
                                aria-controls="profile" aria-selected="false" data-service='Group Tour'>GROUP TOUR</a>

                        </li>

                        <li class="nav-item">

                            <a class="nav-link" data-toggle="tab" href="#hotel-tab" role="tab" aria-controls="profile"
                                aria-selected="false" data-service='Hotels'>HOTELS</a>

                        </li>

                        <li class="nav-item">

                            <a class="nav-link" data-toggle="tab" href="#activities-tab" role="tab" aria-controls="home"
                                aria-selected="true" data-service='Activities'>ACTIVITIES</a>
                        ...
                        <li class="nav-item">
                            ...
                            <a class="nav-link" data-toggle="tab" href="#transfer-tab" role="tab"
                                aria-controls="contact" aria-selected="false" data-service='Transfer'>TRANSFER</a>
            ...
            <div class="col col-12 col-md-6">
                ...
                <div class="ts-who-are-content">
                    ...
                    <div class="ts-section-heading">
                        ...
                        <p class="ts-section-description">We built on this strong foundation aims to provide great
                            customer satisfaction and an exemplary holiday experience. Planning a once to travel with us
                            and get the great experience. Our experts can get you what you want and in the minimal time.
                            We're one of the best travel management companies across the world, it has the experience
                            and infrastructure to handle any customer demand. In addition, we provide customize tours,
                            hotels, flights, visa, transfer, bus, train & activities world wide, We also plans corporate
                            tours, incentive trips, college/school excursions, business travel and much, much more.</p>

                        <p class="ts-section-description">Our aim is to create for our guests; an Experience of a
                            Lifetime!! Take a tour of our happy clients. Enjoy with our exclusive experience.</p>
                ...
                <div class="col col-12 col-md-6 col-lg-6">
                    ...
                    <div class="ts-vision-card">
                        ...
                        <div class="ts-vision-card-body">
                            ...
                            <p class="ts-vision-description">We're professionally managed travel service providing
                                company. Committed to total customer satisfaction & enhancing value of money.</p>
                ...
                <div class="col col-12 col-md-6 col-lg-6">
                    ...
                    <div class="ts-vision-card">
                        ...
                        <div class="ts-vision-card-body">
                            ...
                            <p class="ts-vision-description">Our team shall be an innovative & empowered by technology,
                                constantly creating value & attaining new benchmarks.</p>
...
<section class="ts-adventure-section">
    ...
    <div class="container">
        ...
        <h6>Get the Premium International Destinations, Personalized Tailor Made Tours with us and explore yourself.
        </h6>
                ...
                <div class="col col-12 col-md-6 col-lg-4">
                    ...
                    <div class="ts-blog-card">
                        ...
                        <div class="ts-blog-card-img">
                            ...
                            <img src="<?= file_exists($imgUrl) ? $imgUrl : 'images/hotel_image.png' ?>"
                ...
                <div class="col col-12 col-md-6 col-lg-4">
                    ...
                    <div class="ts-blog-card">
                        ...
                        <div class="ts-blog-card-img">
                            ...
                            <img src="<?= file_exists($imgUrl) ? $imgUrl : 'images/activity_default.png' ?>"
                                alt="Package Image" class="img-fluid ">
        ...
        <div class="row">
            ...
            <div class="col col-12 col-md-8 col-lg-5 ml-auto">
                ...
                <div class="ts-rate-content">
                    ...
                    <p class="ts-section-description">We understand our guests needs to perfection and thus provide them
                        with flexible customized holiday packages according to their needs are requirements. We give
                        proper alternatives with accurate guidance, to make our guests as comfortable as possible.</p>
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col col-12 col-md-6 col-lg-5">
                        ...
                        <div class="ts-testimonial-img">
                            ...
                            <img src="<?= file_exists($newUrl1) ? $newUrl1 : 'images/traveler.png'  ?>"
                                alt="Customer Image" class="img-fluid">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col col-12 col-md-6 col-lg-5">
                    ...
                    <div class="ts-update-img">
                        ...
                        <img src="<?= file_exists($newUrl1) ? $newUrl1 : 'images/activity_default.png' ?>"
