            ...
            <div class="row">
              ...
              while($sq_total_amount = mysqli_fetch_assoc($sq_ticket)){
                ...
                if($sq_total_amount['cancel_type'] != 1 || $sq_total_amount['cancel_type'] != 2 || $sq_total_amount['cancel_type'] != 3){
                  ...
                  $cancel_estimate = json_decode($sq_total_amount['cancel_estimate']);
                  $balance_amount = ($sq_total_amount['ticket_total_cost'] - floatval($cancel_estimate[0]->ticket_total_cost));
...
function ongoing_tours_reflect(){
	$.post('sales/ongoing_tours_reflect.php', { }, function(data){
		$('#ongoing_tours_data').html(data);
	});
}
upcoming_tours_reflect();
function upcoming_tours_reflect(){
	$.post('sales/upcoming_tours_reflect.php', { }, function(data){
