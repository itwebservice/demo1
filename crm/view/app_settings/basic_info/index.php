...
<form id="frm_basic_info">
	...
	<div class="panel panel-default panel-body app_panel_style feildset-panel mg_bt_30">
		...
		<div class="row mg_tp_20">
			...
			<div class="col-md- hidden text-right"><label for="pdf_upload_btn">Cancellation Policy</label></div>
			<?php
...
<button type="button" data-toggle="tooltip" class="btn btn-info btn-sm" onclick="img_view_modal('QR')" title="View Image"><i class="fa fa-eye"></i></button>
				...
				<span style="color: red;" class="note" data-original-title="" title="">Note : Image Size Should Be Less Than 100KB, Resolution : 900 X 900 and Format: Jpg/JEPG/Png</span>
