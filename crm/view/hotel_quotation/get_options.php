                            ...
                            <div class="row mg_bt_10">
                                <div class="col-xs-12 text-right text_center_xs">
                                    <button type="button" class="btn btn-excel btn-sm"
                                        onClick="addRow('dynamic_table_list_h_<?= $i ?>','<?= $i ?>');city_lzloading('.city_master_dropdown')"><i
                                            class="fa fa-plus"></i></button>
                                    <button type="button" class="btn btn-pdf btn-sm"
                                        onClick="deleteRow('dynamic_table_list_h_<?= $i ?>')"><i
                                ...
                                <table style="width: 100%" id="dynamic_table_list_h_<?= $i ?>"
                                    ...
                                    <tr>
                                        ...
                                        <td><select name="meal_plan-<?= $i ?>-1" id="meal_plan-<?= $i ?>-1"
                                                ...
                                                class="form-control app_select2"><?php get_mealplan_dropdown(); ?></select>
                                        </td>
