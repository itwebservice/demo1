                                ...
                                <div class="table-responsive">
                                    <table id="hotel_quotation_costing_update">
                                        ...
                                        <td class="header_btn header_btn" style="padding:4px"><small id="service_show-u_1"
                                                style="color:red"><?= ($inclusive_s == '') ? '&nbsp;' : 'Inclusive Amount : <span>' . $inclusive_s ?></span></small><input
                                        ...
                                        <td class="header_btn header_btn" style="padding:4px"><small>&nbsp;</small><input type="text" id="tax_amount-u_1"
                                                name="tax_amount-u_1" placeholder="Tax Amount" title="Tax Amount"
                                        ...
                                        <td class="header_btn header_btn" style="padding:4px"><small id="markup_show-u_1"
                                                style="color:red"><?= ($inclusive_m == '') ? '&nbsp;' : 'Inclusive Amount : <span>' . $inclusive_m ?></span></small><input type="text" id="tax_markup-u_1" name="tax_markup-u_1" placeholder="Markup Tax" title="Markup Tax"
                                                value="<?= $costDetails['markup_tax'] ?>" onchange="validate_balance(this.id)" readonly> </td>

                                        <td class="header_btn header_btn" style="padding:4px"><small>&nbsp;</small><input type="text" id="roundoff-u_1" name="roundoff-u_1" placeholder="Round Off" title="Round Off"
                                                value="<?= !empty($costDetails['roundoff']) ? $costDetails['roundoff'] : 0.00  ?>"
                                                onchange="validate_balance(this.id)" readonly> </td>

                                        <td class="header_btn header_btn" style="padding:4px"><small>&nbsp;</small><input type="number" id="total_amount-u_1" class="amount_feild_highlight text-right form-control"
                                                name="total_amount-u_1" placeholder="Total Amount" title="Total Amount"
                                                value="<?= !empty($costDetails['total_amount']) ? $costDetails['total_amount'] : 0.00 ?>" onchange="validate_balance(this.id)" readonly> </td>
                                    </table>
                                </div>
                            </div>
                        </div>
                    ...
                    callback: function(data1) {
                        if (data1 == "yes") {
                            ...
                            window.location.href = base_url +
                                'view/hotel_quotation/index.php';
