            ...
            <div class="modal-body">
                <form id="frm_emquiry_edit">
                    <div class="row mg_bt_20">
                        <div class="col-sm-4 col-sm-offset-4">
                            <select name="enquiry_type_u" id="enquiry_type_u" title="Enquiry For"
                                ...
                                <option value="<?= $enq_details['enquiry_type'] ?>" selected>
                                    <?= $enq_details['enquiry_type'] ?></option>
                    ...
                    <div class="row mg_tp_10">
                        ...
                        <div class="col-md-3 col-sm-6 mg_bt_10">
                            <input type="number" class="form-control" id="txt_mobile_no_u"
                                onchange="mobile_validate(this.id);" name="txt_mobile_no_u" placeholder="*Mobile No"
                                title="Mobile No" value="<?= $enq_details['mobile_no'] ?>">
                        </div>
                        <div class="col-md-3 col-sm-6 mg_bt_10">
                            <div class="row">
                                <div class="col-md-6" style="padding-right:0px;">
                                    <input type="hidden" name="country_code_val" id="country_code_val"
                                        value="<?= $enq_details['country_code'] ?>">
                                    <select name="country_code1" title="Country Code" id="country_code1" style="width:130px;">
                                        <?= get_country_code(); ?>
                                    </select>
                                </div>
                                <div class="col-md-6">
                                    <input type="number" class="form-control" id="txt_landline_no_u"
                                        onchange="mobile_validate(this.id);" name="txt_landline_no_u"
                                        placeholder="WhatsApp No" title="WhatsApp No"
                                        value="<?= str_replace($enq_details['country_code'], "", $enq_details['landline_no']) ?>">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-6 mg_bt_10">
                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-6 mg_bt_10_xs">
                                <select name="assigned_emp_id_u" id="assigned_emp_id_u" title="Allocate To"
                                    ...
                                    <option value="<?= $query1['emp_id'] ?>">
                                        <?= $query1['first_name'] . ' ' . $query1['last_name'] ?></option>
