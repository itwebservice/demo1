                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
                            ...
                            <select id="booking_id" style="width: 100%" name="booking_id" title="Booking ID"
                                ...
                                <option value="<?php echo $row_booking['booking_id'] ?>">
                                    <?php echo get_package_booking_id($row_booking['booking_id'], $year) . "-" . " " . $sq_customer['company_name'] . ' ' . $status; ?>
                                </option>
                                <?php } else { ?>
                                <option value="<?php echo $row_booking['booking_id'] ?>">
                                    <?php echo get_package_booking_id($row_booking['booking_id'], $year) . "-" . " " . $sq_customer['first_name'] . " " . $sq_customer['last_name'] . ' ' . $status; ?>
                                </option>
                                <?php
                                    }
                                }
