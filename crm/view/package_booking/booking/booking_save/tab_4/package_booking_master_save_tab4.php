                                ...
                                <div class="main_block text-center">
                                    ...
                                    <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
                                        ...
                                        <input type="text" id="service_charge" name="service_charge"
                                            ...
                                            onchange="get_auto_values('txt_booking_date','total_basic_amt','payment_mode','service_charge','markup','save','false','service_charge','discount');validate_balance(this.id);calculate_tour_cost(this.id)">
                                    </div>
                                    <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
                                        ...
                                        <div class="row">
                                            ...
                                            <div
                                                ...
                                                <select id="cmb_payment_mode1" name="cmb_payment_mode1" title="Mode"
                                                    onchange="payment_installment_enable_disable_fields('1');get_auto_values('txt_booking_date','total_basic_amt','payment_mode','service_charge','markup','save','true','basic','discount',true);get_identifier_block('identifier','cmb_payment_mode1','credit_card_details','credit_charges');get_credit_card_charges('identifier','cmb_payment_mode1','txt_amount1','credit_card_details','credit_charges')"><?php get_payment_mode_dropdown(); ?>
                                                </select>
                                            </div>
                                            <div
                                                class="col-md-2 col-sm-4 col-xs-12 text_center_xs mg_bt_10_xs mg_tp_10">
                                ...
                                <div class="main_block mg_bt_20">
                                    ...
                                    <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10_xs">
                                        <input type="text" id="txt_booking_date" name="txt_booking_date"
                                            ...
                                            onchange="get_auto_values('txt_booking_date','total_basic_amt','payment_mode','service_charge','markup','save','true','service_charge','discount',true);check_valid_date(this.id)" />
                                    </div>
                                </div>
                            </div>
                        </div>
