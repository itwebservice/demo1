                            ...
                            <div class="row ">
                                ...
                                <div class="col-md-3 col-sm-4 col-xs-12 mg_bt_10">
                                    <input type="text" id="txt_package_from_date" name="txt_package_from_date"
                                        ...
                                        value="<?php echo get_date_user($sq_booking_info['tour_from_date']) ?>"
                                        readonly>
                                </div>
                                <div class="col-md-3 col-sm-4 col-xs-12 mg_bt_10">
                                    <input type="text" id="txt_package_to_date" name="txt_package_to_date"
                                        placeholder="To Date" title="To Date"
                                        value="<?php echo get_date_user($sq_booking_info['tour_to_date']) ?>" readonly>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="company_class">
                                <input type="text" id="company_name1" name="company_name" class="hidden"
                                    title="Company Name" value="<?php echo $sq_booking_info['company_name'] ?>">
                            </div>
                            <?php } ?>
                            <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
                                <input type="text" id="txt_m_address1" name="txt_m_address" placeholder="Address"
                                    title="Address" value="<?php echo $sq_booking_info['address'] ?>" readonly>
                            </div>
                            <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
                                <select id="txt_m_state1" name="txt_m_state" title="State/Country Name" style="width:100%" disabled>
                                    <?php
                            ...
                            <!-- <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
                                <select name="country_name" id="country_name1" title="Country Name" style="width:100%"
                                    ...
                                    ?>
                                    <option value="<?php echo $sq_booking_info['country_name'] ?>">
                                        <?php echo $sq_booking_info['country_name'] ?></option>
                                    <?php } ?>
