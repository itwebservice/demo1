                        ...
                        <div class="row" style="margin-top: 5px">
                            <div class="col-md-12 text-right">
                                <button type="button" class="btn btn-excel btn-sm"
                                    onClick="addRow('tbl_package_hotel_infomration')" title="Add row"><i
                                    ...
                                    <table id="tbl_package_hotel_infomration"
                                        ...
                                        <tr>
                                            ...
                                            <td><select title="Meal Plan" id="cmb_meal_plan<?= $count_ht ?>_t"
                                                    ...
                                                    <option value="<?= $row_hotel_acc['meal_plan'] ?>">
                                                        <?= $row_hotel_acc['meal_plan'] ?></option>
                                                    <?php get_mealplan_dropdown(); ?>
                                                </select></td>
                                            <td><select name="room_type<?= $count_ht ?>_t" id="room_type"
                                                    title="Room Type" style="width:100px">
                                                    <option value="<?= $row_hotel_acc['room_type'] ?>">
                                                        <?= $row_hotel_acc['room_type'] ?></option>
                                    ...
                                    <table id="tbl_package_transport_infomration"
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" id="txt_tsp_from_date<?= $count_tt ?>-u"
                                                    name="txt_tsp_from_date<?= $count_tt ?>-u" placeholder="Start Date"
                                                    title="Start Date" style="width: 170px"
                                                    value="<?= get_date_user($row_trans_acc['transport_from_date']) ?>"
                                                    class="form-control app_datepicker"
                                                    onchange="get_to_date(this.id,'txt_tsp_end_date<?= $count_tt ?>-u')">
                                            </td>
                                            <td><input type="text" id="txt_tsp_end_date<?= $count_tt ?>-u"
                                                    name="txt_tsp_end_date<?= $count_tt ?>-u" placeholder="End Date"
                                                    title="End Date" style="width: 170px"
                                                    value="<?= get_date_user($row_trans_acc['transport_end_date']) ?>"
                                                    class="form-control app_datepicker"
                                                    onchange="validate_validDate('txt_tsp_from_date<?= $count_tt ?>-u','txt_tsp_end_date<?= $count_tt ?>-u')">
                                            </td>
                                            ...
                                            <td style="display:none"><input type="text"
                                                    value="<?php echo $row_trans_acc['entry_id'] ?>"></td>
                                        </tr>
                                        <script>
