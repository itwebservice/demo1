                                ...
                                <div class="row mg_tp_10 mg_bt_10">
                                    ...
                                    <div class="col-xs-12 text-right text_center_xs">
                                        ...
                                        <button type="button" class="btn btn-excel btn-sm"
                                            onclick="addRow('tbl_flight_quotation_dynamic_plane');event_airport('tbl_flight_quotation_dynamic_plane');"><i
                                                class="fa fa-plus"></i></button>
                                        <button type="button" class="btn btn-pdf btn-sm"
                                            onclick="deleteRow('tbl_flight_quotation_dynamic_plane')"><i
