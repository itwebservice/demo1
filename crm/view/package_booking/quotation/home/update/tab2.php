        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-4 col-sm-4 col-xs-12">
                    ...
                    <input type="text" value="<?= $sq_pacakge['package_name']. ' (' . $sq_pacakge['total_days'] . 'D/' . $sq_pacakge['total_nights'] . 'N )' ?>" readonly>
                                ...
                                <div class="col-md-12 no-pad" id="div_list1">
                                    <div class="row mg_bt_10">
                                        <div class="col-xs-12 text-right text_center_xs">
                                            <button type="button" class="btn btn-excel btn-sm"
                                                onClick="addRow('dynamic_table_list_update','','itinerary')"><i
                                        ...
                                        <table style="width:100%" id="dynamic_table_list_update"
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 50px;" class="hidden"><input maxlength="15"
                                                        value="<?= $offset ?>" type="text" name="username"
                                                ...
                                                <td style="width: 100px;"><input type="text"
                                                        ...
                                                        style='width:220px;'
                                                        value="<?php echo $row_program['attraction']; ?>"></td>
                                                <td style="width: 100px;max-width: 594px;overflow: hidden;"><textarea
                                                ...
                                                <td class='col-md-2 no-pad' style='width:100px;'><input type="text"
                                                        id="overnight_stay<?php echo $offset; ?>-u"
                                                        name="overnight_stay"
                                                        onchange="validate_spaces(this.id);validate_onstay(this.id);"
                                                        class="form-control mg_bt_10" placeholder="*Overnight Stay"
                                                        title="Overnight Stay"
                                                        value="<?php echo $row_program['stay']; ?>"
                                                        style='width:170px;'></td>
                                                <td><select id="meal_plan<?php echo $offset; ?>" title="Meal Plan"
                                                        name="meal_plan" class="form-control mg_bt_10"
                                                        style='width: 140px;'>
                                                ...
                                                <td class='col-md-1 pad_8'><button type="button"
                                                        ...
                                                        title="Add Itinerary" id="itinerary<?php echo $offset; ?>"
                                                        onclick="add_itinerary('dest_name','special_attaraction<?php echo $offset; ?>-u','day_program<?php echo $offset; ?>-u','overnight_stay<?php echo $offset; ?>-u','Day-<?= $offset ?>')"><i
                                                            class="fa fa-plus"></i></button>
                                                </td>
                                                <td style="width: 100px;"><input type="hidden" name="package_id_n"
                                                        value="<?php echo $row_program['id']; ?>"></td>
                                            </tr>
                                            <?php } ?>
                                        </table>
                                    </div>
                                    <div class="row mg_tp_20">
                                        <div class="col-md-6">
                                            ...
                                            <textarea class="feature_editor form-control" id="inclusions1"
                                                name="inclusions1" placeholder="Inclusions" title="Inclusions"
                                                rows="4"><?php echo $sq_quotation['inclusions']; ?></textarea>
                                        </div>
                                        <div class="col-md-6">
                                            <h3 class="editor_title">Exclusions</h3>
                                            <textarea class="feature_editor form-control" id="exclusions1"
                                                name="exclusions1" placeholder="Exclusions" title="Exclusions"
                                                rows="4"><?php echo $sq_quotation['exclusions']; ?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
