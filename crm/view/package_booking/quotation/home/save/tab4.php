                                                            ...
                                                            <div class="table-responsive">
                                                                <table id="tbl_package_tour_quotation_dynamic_costing" name="tbl_package_tour_quotation_dynamic_costing" class="table border_0 no-marg">
                                                                    <tr>
                                                                        ...
                                                                        <td class="header_btn"><small>&nbsp;</small><input type="text" id="package_type-" name="package_type-" placeholder="Package Type" title="Package Type" style="width:150px" readonly><span>Package
                                                                                Type</span></td>
                                                                        ...
                                                                        <td class="header_btn"><small id="basic_show-" style="color:#000000">&nbsp;</small><input type="<?= $add_class1 ?>" id="basic_amount-" name="basic_amount-" onchange="get_business(this.id,'true');validate_balance(this.id);" placeholder="Basic Amount" title="Basic Amount" style="width:100px" readonly><span>Basic Amount</span></td>
                                                                    ...
                                                                    <div class="table-responsive">
                                                                        <table id="tbl_package_tour_quotation_adult_child" name="tbl_package_tour_quotation_adult_child" class="table border_0 no-marg">
                                                                            <tr>
                                                                                ...
                                                                                <td><input type="text" onchange="validate_balance(this.id);" id="child_without" name="child_without" placeholder="Child w/o Bed Cost" title="Child w/o Bed Cost">
                                                                                </td>
...
<script>
    ...
    function get_business(id, flag, change = false) {
        ...
        get_auto_values('quotation_date', 'basic_amount-' + offset[1], 'payment_mode', 'service_charge-' + offset[1],
            'markup', 'save', flag, 'markup', 'discount', offset[1], change);
    }
