                                    ...
                                    <table id="tbl_package_tour_quotation_dynamic_costing"
                                        ...
                                        <tr>
                                            ...
                                            <td class="header_btn"><small id="basic_show-"
                                                    ...
                                                    onchange="get_business(this.id,'true',true);validate_balance(this.id);"
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <div class="row mg_tp_20">
                        ...
                        <div class="col-md-3 col-sm-6 col-sm-12 mg_bt_10">
                            <select name="costing_type" id="costing_type" title="Select Costing type"
                                class="form-control">
                    ...
                    <div class="row mg_tp_20">
                        <div class="col-md-6 col-sm-12">
                            <span style="color: red;" class="note">Note : Group Costing or Per person costing to display
                                on quotation</span>
                        </div>
                    ...
                    <div class="row mg_tp_20 text-center mg_bt_30">
                        <div class="col-md-12">
                            ...
                            &nbsp;&nbsp;
                            <button class="btn btn-sm btn-success" id="btn_quotation_save"><i
