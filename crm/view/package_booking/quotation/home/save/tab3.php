                                ...
                                <div id="collapse4" class="panel-collapse collapse main_block" role="tabpanel"
                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-xs-12 text-right mg_bt_20_sm_xs">
                                                <button type="button" class="btn btn-excel btn-sm"
                                                    onClick="addRow('tbl_package_tour_quotation_dynamic_hotel');city_lzloading('.city_name1');"><i
                                                        class="fa fa-plus"></i></button>
                                            </div>
                                        </div>
                                        <div class="row">
                                                    ...
                                                    <table id="tbl_package_tour_quotation_dynamic_hotel"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><select name="room_cat-1" id="room_cat-1"
                                                                    ...
                                                                    onchange="get_hotel_cost();"><?php get_room_category_dropdown(); ?></select>
                                                            </td>
                                                            ...
                                                            <td class="hidden"><input type="text" id="package_name1"
                                                                    ...
                                                                    title="Package Name"
                                                                    style="width:200px;display:none;" readonly></td>
                                ...
                                <div id="collapse5" class="panel-collapse collapse main_block" role="tabpanel"
                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-xs-12 text-right mg_bt_20_sm_xs">
                                                <button type="button" class="btn btn-excel btn-sm"
                                                    onClick="addRow('tbl_package_tour_quotation_dynamic_transport');destinationLoading('.pickup_from', 'Pickup Location');destinationLoading('.drop_to', 'Drop-off Location');"><i
                                                        class="fa fa-plus"></i></button>
                                            </div>
                                        </div>
                                        <div class="row">
                                ...
                                <div id="collapse6" class="panel-collapse collapse main_block" role="tabpanel"
                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-xs-12 text-right mg_bt_20_sm_xs">
                                                <button type="button" class="btn btn-excel btn-sm"
                                                    onClick="addRow('tbl_package_tour_quotation_dynamic_excursion');city_lzloading('.exc_city')"><i
                                                        class="fa fa-plus"></i></button>
                                                <button type="button" class="btn btn-pdf btn-sm"
                                                    ...
                                                    <table id="tbl_package_tour_quotation_dynamic_excursion"
                                                        ...
                                                        <tr>
                                                            <td><input class="css-checkbox" id="chk_tour_group-1"
                                                                    ...
                                                                    class="css-label" for="chk_tour_group2"> <label>
                                                            </td>
