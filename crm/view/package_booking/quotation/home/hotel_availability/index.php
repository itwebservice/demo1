      ...
      <div class="modal-content">
          ...
          <div class="modal-body profile_box_padding">
            ...
            while($row_query = mysqli_fetch_assoc($query)){
                ...
                $availability_details1 = ($row_query['availability']!='') ? $row_query['availability'] : '';
              ...
              <div class="row mg_tp_10"><div class='col-md-12'>
                Replied By: <span id="reply_by<?= $count ?>"><?= $availability_details->reply_by ?></span>, Specification: <span id="spec<?= $count ?>"><?= $availability_details->spec ?></span>
              </div></div>
              <div id="optional_hotel_section<?= $count ?>" class="mg_tp_10">
                <?php
                if($availability_details->availability == 'Not Available'){ ?>
                  <div class="row">
