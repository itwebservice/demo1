...
$hotel_flag = $_GET['hotel_flag'];
$sq_req = mysqli_fetch_assoc(mysqlQuery("select availability from package_tour_quotation_hotel_entries where id='$request_id'"));
$response = ($sq_req['availability'] == "") ? json_encode(array()) : $sq_req['availability'];
$response1 = json_decode($response);
$option_hotel_arr = json_encode($response1->option_hotel_arr);
$emp_id = $response1->emp_id;
$email_id = $response1->email_id;
$availability = $response1->availability;
$reply_by = $response1->reply_by;
$spec = $response1->spec;
?>
<head>
