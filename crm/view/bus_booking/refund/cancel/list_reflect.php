...
<div class="row">
    ...
    <div class="row mg_tp_20">
        <div class="col-md-6 col-sm-10  col-xs-12 mg_tp_10" style="margin-left:2%;">
    ...
    <div class="col-md-12 col-md-offset-0 col-sm-8 col-sm-offset-2 col-xs-12" style="padding-top: 30px;">
        <div class="table-responsive">
            ...
            <div class="panel panel-default panel-body text-center">
                <button class="btn btn-danger btn-sm ico_left" id="cancel_booking" onclick="cancel_booking()"><i
...
<form id="frm_refund" class="mg_bt_150">
    ...
    <div class="row text-center">
        <div class="col-md-3 col-md-offset-3 col-sm-6 col-xs-12 mg_bt_10_xs">
            <input type="text" name="cancel_amount" id="cancel_amount" class="text-right"
                placeholder="*Cancellation Charges" title="Cancellation Charges"
                onchange="calculate_total_refund();validate_balance(this.id);"
                value="<?= $sq_booking['cancel_amount'] ?>">
        </div>
