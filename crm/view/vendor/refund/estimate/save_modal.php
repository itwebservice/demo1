        ...
        <div class="modal-body">
          ...
          <div class="row">
            ...
            if ($sq_cancel_count > 0) {
              $cancel_estimate = ($sq_est_info['cancel_estimate']!='') ? json_decode($sq_est_info['cancel_estimate'])[0] : '';
            ?>
            <div class="row">
              <div class="col-md-3 col-sm-4 col-xs-12 mg_bt_10_xs">
              <small>Purchase Return</small>
                
              <select name="purchase_return" id="purchase_return" style="width:100%" onchange="content_reflect()" title="Purchase Return" data-toggle="tooltip" required>
              <?php 
              if($sq_est_info['purchase_return'] != '0'){
                ...
                <small>Service Charge</small>
                    <input type="number" id="service_charge" name="service_charge"
                        placeholder="Service Charge" title="Service Charge" onchange="calculate_estimate_amount()" value="<?= floatval($cancel_estimate->service_charge) ?>">
                </div>
                <div class="col-md-3 col-sm-4 col-xs-12 mg_bt_10">
                <small>Tax Amount</small>
                    <input type="text" id="service_tax_subtotal" name="service_tax_subtotal"
                        placeholder="Tax Amount" title="Tax Amount" onchange="calculate_estimate_amount()" value="<?= floatval($cancel_estimate->service_tax_subtotal) ?>">
                </div>
                <div class="col-md-3 col-sm-4 col-xs-12 mg_bt_10">
                <small>Round Off</small>
                    <input type="text" id="roundoff" class="form-control" name="roundoff"
                        placeholder="Round Off" title="Round Off" onchange="calculate_estimate_amount()" value="<?= floatval($cancel_estimate->roundoff) ?>" readonly>
                </div>
                <div class="col-md-3 col-sm-4 col-xs-12 mg_bt_10">
                <small>Net Total</small>
                    <input type="text" id="net_total" class="amount_feild_highlight text-right"
                        name="net_total" placeholder="*Net Total" title="Net Total" onchange="calculate_estimate_amount()" value="<?= floatval($cancel_estimate->net_total) ?>" readonly>
                </div>
                <div class="col-md-3 col-sm-4 col-xs-12 mg_bt_10">
