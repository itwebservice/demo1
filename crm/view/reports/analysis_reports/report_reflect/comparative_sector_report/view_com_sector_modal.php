...
$qry1 = "SELECT plane_master.seats,plane_master.arraval_time,plane_master.plane_id,count(*)as sector ,sum(tourwise_traveler_details.plane_expense) as purchase, plane_master.plane_id,customer_master.first_name,customer_master.last_name, tourwise_traveler_details.form_date,customer_master.customer_id,tourwise_traveler_details.form_date,tourwise_traveler_details.id 
FROM plane_master 
                            ...
                            <tbody>
                                ...
                                ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo (int)$db['adults'] + (int)$db['childrens'] ; ?></td>
                                            <td><?php
