...
$qry = "SELECT airline_master.airline_id,count(*)as sector,sum(ticket_master.ticket_total_cost) as purchase,ticket_trip_entries.ticket_id,ticket_master.adults,ticket_master.childrens,ticket_master.infant,ticket_master.ticket_total_cost,customer_master.first_name,customer_master.last_name,customer_master.customer_id,ticket_master.created_at FROM airline_master INNER JOIN ticket_trip_entries on airline_master.airline_id = ticket_trip_entries.airline_id inner join ticket_master on ticket_trip_entries.ticket_id = ticket_master.ticket_id INNER JOIN customer_master on ticket_master.customer_id = customer_master.customer_id where 1=1 ".$_SESSION['dateqry']."AND airline_master.airline_id='".$airline_id."' GROUP BY ticket_master.ticket_id";
$sq_query = mysqlQuery($qry);

$qry1 = "SELECT airline_master.airline_id,plane_master.plane_id,count(*)as sector ,sum(tourwise_traveler_details.plane_expense) as purchase, plane_master.plane_id,customer_master.first_name,customer_master.last_name, plane_master.seats,customer_master.customer_id,tourwise_traveler_details.form_date
 FROM plane_master 
                    ...
                    <div class="col-md-12">
                      <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><?php
                                       ...
                                       $yr = explode("-", $date);
                                       $year =$yr[0];
                                       echo get_ticket_booking_id($db['airline_id'],$year);
                           ...
                           <tr>
                               ...
                               $yr = explode("-", $date);
                               $year =$yr[0];
                               echo get_group_booking_id($db['airline_id'],$year);
