...
<div class="col-md-12 text-right">
		<button class="btn btn-excel btn-sm" onclick="exportToExcel('supplier_wise_report')" data-toggle="tooltip" title="Generate Excel"><i class="fa fa-file-excel-o"></i></button>
	</div>
...
<div class="app_panel_content Filter-panel">
		<div class="row">
			...
			<div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
				...
				<option value="hotelVendor">Hotel Vendor</option>
					<option value="carrentalVendor">Car Rental Vendor</option>
					<option value="transport">Transport Vendor</option>
					<option value="trainTicket">Train Ticket Vendor</option>
					<option value="cruiseMsater">Cruise Vendor</option>
					<!-- <option value="dmcMaster">DMC Vendor</option> -->
					<option value="visaVendor">Visa Vendor</option>
					<option value="insuranceVendor">Insurance Vendor</option>
					<!-- <option value="otherVendor">Other Vendor</option> -->
					<option value="ticketVendor">Ticket Vendor</option>
					<option value="siteSeeing">Excursion Vendor</option>
				</select>
			</div>
			<div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
...
<table id="supplier_wise_report" class="table table-hover" style="margin: 20px 0 !important;">         
</table>
</div></div></div>
</div>
...
$( "#from_date, #to_date" ).datetimepicker({ timepicker:false, format:'d-m-Y' });        
	...
	{ title : "Actions" , class : "no-export"},
		...
		// $('#div_list').html(data);
		pagination_load(data, column, true, true, 20, 'supplier_wise_report');
	});
	}
