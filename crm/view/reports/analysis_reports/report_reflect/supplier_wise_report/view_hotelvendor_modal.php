...
$qry = mysqlQuery("select * from vendor_estimate inner join hotel_booking_master on hotel_booking_master.booking_id=vendor_estimate.estimate_type_id
inner join customer_master on hotel_booking_master.customer_id=customer_master.customer_id
where vendor_estimate.vendor_type_id='$hotelId' and vendor_estimate.vendor_type='$hotelName' and vendor_estimate.estimate_type='Hotel Booking' and vendor_estimate.delete_status='0'") or die('error');
