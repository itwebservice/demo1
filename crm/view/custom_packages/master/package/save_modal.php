            ...
            <div class="app_panel_content no-pad">
                    ...
                    <div class="row mg_bt_10">
                        <div class="col-xs-12 no-pad mg_bt_20 mg_tp_20">
                            <div class="col-md-3 col-sm-3">
                                <select id="dest_name_s" name="dest_name_s" title="Select Destination"
                                    class="form-control" style="width:100%" onchange="get_dest_image(this.id)">
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
                                <select name="tour_type" id="tour_type" title="Tour Type"
                                    onchange="incl_reflect(this.id,'')" required>
                            ...
                            <div class="col-md-3 col-sm-3 mg_bt_10_xs">
                                <select id="dest_image" name="dest_image" title="Destination Image"
                                    class="form-control">
                        ...
                        <div class="col-xs-12 no-pad mg_bt_20">
                            ...
                            <div class="col-md-3 col-sm-3 mg_bt_10_xs">
                                <input type="number" id="total_nights"
                                    onchange="validate_balance(this.id); calculate_days()" name="total_nights"
                                    placeholder="*Nights" title="Total Nights">
                            </div>
                            <div class="col-md-3 col-sm-3 mg_bt_10_xs">
                                <input type="number" id="total_days"
                                    onchange=" validate_days('total_nights' , 'total_days');" name="total_days"
                                    class="form-control" placeholder="*Days" title="Total Days" readonly />
                            </div>
                            <div class="col-md-3 col-sm-3">
                        ...
                        <div class="col-xs-12 no-pad mg_bt_20 hidden">
                            <div class="col-md-2 col-sm-3 mg_bt_10_xs">
                                <input type="text" id="adult_cost" name="adult_cost"
                                    onchange="validate_balance(this.id);" class="form-control" placeholder="Adult Cost"
                                    title="Adult Cost" />
                            </div>
                            <div class="col-md-2 col-sm-3 mg_bt_10_xs">
                                <input type="text" id="child_cost" name="child_cost"
                                    onchange="validate_balance(this.id);" class="form-control" placeholder="Child Cost"
                                    title="Child Cost" />
                            </div>
                            <div class="col-md-2 col-sm-3 mg_bt_10_xs">
                                <input type="text" id="infant_cost" name="infant_cost"
                                    onchange="validate_balance(this.id);" class="form-control" placeholder="Infant Cost"
                                    title="Infant Cost" />
                            </div>
                            <div class="col-md-2 col-sm-3 mg_bt_10_xs">
                                <input type="text" id="child_with" name="child_with"
                                    onchange="validate_balance(this.id);" class="form-control"
                                    placeholder="Child with Bed Cost" title="Child with Bed Cost" />
                            </div>
                            <div class="col-md-2 col-sm-3 mg_bt_10_xs">
                                <input type="text" id="child_without" name="child_without"
                                    onchange="validate_balance(this.id);" class="form-control"
                                    placeholder="Child w/o Bed Cost" title="Child w/o Bed Cost" />
                            </div>
                            <div class="col-md-2 col-sm-3 mg_bt_10_xs">
                                <input type="text" id="extra_bed" name="extra_bed" onchange="validate_balance(this.id);"
                                    class="form-control" placeholder="Extra Bed Cost" title="Extra Bed Cost" />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="panel panel-default panel-body app_panel_style feildset-panel mg_tp_20">
                    ...
                    <div class="row mg_bt_20">
                        <div class="col-md-6 mg_tp_20"> <small class="note text-left">Note - Please ensure you added city wise hotel & tariff using Supplier Master</small></div>
                        ...
                        <div class="col-xs-12">
                            <div class="table-responsive" style="height:115px;">
                                <table id="tbl_package_hotel_master" name="tbl_package_hotel_master"
                                    class="table table-hover" style="border-bottom: 0 !important;">
                                    <tr>
                ...
                <div class="panel panel-default panel-body app_panel_style feildset-panel mg_tp_20">
                    ...
                    <div class="row mg_bt_20">
                        <div class="col-md-6 mg_tp_20"> <small class="note text-left">Note - Please ensure you added transfer tariff</small></div>
                        ...
                        <div class="col-xs-12">
                            <div class="table-responsive">
                                <table id="tbl_package_tour_transport" name="tbl_package_tour_transport"
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="col-md-1"><input class="css-checkbox labelauty"
                                                    id="chk_transport1" type="checkbox" checked="" autocomplete="off"
                                                    data-original-title="" title="" aria-hidden="true"
                                            ...
                                            <td class="col-md-1"><input maxlength="15" value="1" type="text"
                                                    name="username" placeholder="Sr No." class="form-control"
                                                    disabled="" autocomplete="off" data-original-title="" title=""></td>
                                            <td class="col-md-3"><select name="vehicle_name1" id="vehicle_name1"
                                                    title="Select Vehicle" style="width:100%"
                                            ...
                                            <td class="col-md-3"><select name="pickup_from" id="pickup_from"
                                                    data-toggle="tooltip" style="width:100%;" title="Pickup Location"
                                                    class="form-control app_minselect2">
                                                </select></td>
                                            <td class="col-md-3"><select name="drop_to" id="drop_to" style="width:100%;"
                ...
                <div class="row mg_bt_20">
                    <div class="col-md-12 col-sm-6 mg_bt_10_sm_xs">
                        <textarea class="form-control" id="note" name="note" placeholder="Note" title="Note"
                            rows="2"></textarea>
                    </div>
                </div>
                <div class="row mg_bt_20">
        ...
        submitHandler: function(form, event) {
            ...
            for (var i = 0; i < rowCount; i++) {
                ...
                if (row.cells[0].childNodes[0].checked) {
                    ...
                    total_night = parseFloat(total_night) + parseFloat(row.cells[5].childNodes[0]
                        .value);
