                ...
                <div class="panel panel-default panel-body app_panel_style feildset-panel mg_tp_20">
                    ...
                    <div class="row mg_bt_20">
                        ...
                        <div class="col-xs-6 text-right mg_tp_10">
                            <button type="button" class="btn btn-info btn-sm ico_left" title="Add Vehicle" onclick="vehicle_save_modal('<?php echo $vehcile_id_str; ?>')"><i class="fa fa-plus"></i>&nbsp;&nbsp;Vehicle</button>
