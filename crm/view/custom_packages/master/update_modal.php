                ...
                <div class="container-fluid">
                            ...
                            <div class="bg_white main_block panel-default-inner">
                                <div class="col-xs-12 no-pad mg_bt_20 mg_tp_20">
                                    <div class="col-md-3 col-sm-3">
                                        ...
                                        ?>
                                        <select id="dest_name_u" name="dest_name_u" title="Select Destination"
                                    ...
                                    <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
                                        <select name="tour_type" id="tour_type" title="Tour Type"
                                            onchange="incl_reflect(this.id,'1')" <?= $status ?>>
                                    ...
                                    <div class="col-md-3 mg_bt_10">
                                        <select name="currency_code" id="currency_code1" title="Currency"
                                            style="width:100%">
                                    ...
                                    <div class="col-md-3 col-sm-3 mg_bt_10_xs">
                                        <select id="dest_image1" name="dest_image1" title="Destination Image"
                                            class="form-control">
                                            <?php
                                ...
                                <div class="col-xs-12 no-pad mg_bt_20 mg_tp_20">
                                    ...
                                    <div class="col-md-3 col-sm-6 mg_bt_10_xs">
                                        ...
                                        <input type="text" id="package_name1" name="package_name" class="form-control"
                                    ...
                                    <div class="col-md-3 col-sm-6 mg_bt_10_xs">
                                        ...
                                        <input type="text" id="package_code1" name="package_code1" class="form-control"
                                            placeholder="Package Code" title="Package Code"
                                            value="<?php echo $sq_pckg['package_code']; ?>" />
                                    ...
                                    <div class="col-md-2 col-sm-6 mg_bt_10_xs">
                                        ...
                                        <input type="text" id="total_nights1" name="total_nights1" class="form-control"
                                            onchange="validate_balance(this.id); calculate_days()"
                                            value="<?php echo $sq_pckg['total_nights']; ?>" placeholder="Total Nights"
                                            title="Total Nights" />

                                    </div>

                                    <div class="col-md-2 col-sm-6 mg_bt_10_xs">
                                        <input type="text" id="total_days1" name="total_days1" class="form-control"
                                            placeholder="Total Days" title="Total Days"
                                            value="<?php echo $sq_pckg['total_days']; ?>" readonly />
                                    </div>
                                    <div class="col-md-2 col-sm-6">
                                        <select id="status1" name="status1" title="Status"
                                            class="<?= $active_inactive_flag ?>">
                                ...
                                <div class="col-xs-12 no-pad mg_bt_20 mg_tp_20 hidden">
                                    <div class="col-md-2 col-sm-3 mg_bt_10_xs">
                                        <input type="text" id="adult_cost1" name="adult_cost" class="form-control"
                                            placeholder="Adult Cost" title="Adult Cost"
                                            value="<?php echo $sq_pckg['adult_cost']; ?>" />
                                    </div>
                                    <div class="col-md-2 col-sm-3 mg_bt_10_xs">
                                        <input type="text" id="child_cost1" name="child_cost" class="form-control"
                                            placeholder="Child Cost" title="Child Cost"
                                            value="<?php echo $sq_pckg['child_cost']; ?>" />
                                    </div>
                                    <div class="col-md-2 col-sm-3 mg_bt_10_xs">
                                        <input type="text" id="infant_cost1" name="infant_cost"
                                            onchange="validate_balance(this.id);" class="form-control"
                                            placeholder="Infant Cost" title="Infant Cost"
                                            value="<?php echo $sq_pckg['infant_cost']; ?>" />
                                    </div>
                                    <div class="col-md-2 col-sm-3 mg_bt_10_xs">
                                        <input type="text" id="child_with1" name="child_with"
                                            onchange="validate_balance(this.id);" class="form-control"
                                            placeholder="Child with Bed Cost" title="Child with Bed Cost"
                                            value="<?php echo $sq_pckg['child_with']; ?>" />
                                    </div>
                                    <div class="col-md-2 col-sm-3 mg_bt_10_xs">
                                        <input type="text" id="child_without1" name="child_without"
                                            onchange="validate_balance(this.id);" class="form-control"
                                            placeholder="Child w/o Bed Cost" title="Child w/o Bed Cost"
                                            value="<?php echo $sq_pckg['child_without']; ?>" />
                                    </div>
                                    <div class="col-md-2 col-sm-3 mg_bt_10_xs">
                                        <input type="text" id="extra_bed1" name="extra_bed"
                                            onchange="validate_balance(this.id);" class="form-control"
                                            placeholder="Extra Bed Cost" title="Extra Bed Cost"
                                            value="<?php echo $sq_pckg['extra_bed']; ?>" />
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="panel panel-default panel-body app_panel_style feildset-panel mg_tp_20">
                            ...
                            <div id="div_list1">
                                <table style="width: 100%" id="dynamic_table_list_update"
                                    name="dynamic_table_list_update"
                                    ...
                                    <tr>
                                        <td width="27px;"><input class="css-checkbox mg_bt_10 labelauty"
                                                id="chk_program<?php echo $count; ?>" type="checkbox" checked
                                                autocomplete="off" data-original-title="" title="" aria-hidden="true"
                                                style="display: none;"><label
                                                for="chk_program<?php echo $count; ?>"><span
                                                    class="labelauty-unchecked-image"></span><span
                                                    class="labelauty-checked-image"></span></label><label
                                                class="css-label" for="chk_program1"> </label></td>
                                        <td class='hidden col-md-1 pad_8'><input maxlength="15"
                                                value="<?php echo $count; ?>" type="text" name="username"
                                                placeholder="Sr. No." class="form-control mg_bt_10" disabled=""
                                                autocomplete="off" data-original-title="" title="" style='width:10px'>
                                        </td>
                                        <td style='width:140px'><input type="text"
                                                ...
                                                style='width:150px' value="<?php echo $sq_pckg1['attraction']; ?>"></td>

                                        <td class='col-md-7 pad_8' style="max-width: 594px;overflow: hidden;"><textarea
                                                id="day_program<?php echo $count; ?>-u" name="day_program"
                                                class="form-control mg_bt_10" placeholder="*Day Program"
                                                title="Day-wise Program"
                                                onchange="validate_spaces(this.id);validate_dayprogram(this.id);"
                                                rows="3" value="<?php echo $sq_pckg1['day_wise_program']; ?>"
                                                style='width:100%'><?php echo $sq_pckg1['day_wise_program']; ?></textarea>
                                        </td>
                                        ...
                                        <td class='col-md-2 pad_8' style='width:100px'><input type="text"
                                                ...
                                                placeholder="*Overnight Stay" title="Overnight Stay" style='width:150px'
                                                value="<?php echo $sq_pckg1['stay']; ?>"></td>

                                        <td class='col-md-1 pad_8'><select id="meal_plan<?php echo $count; ?>"
                                                title="Meal Plan" name="meal_plan" class="form-control mg_bt_10"
                                                style='width:125px'>
                                        ...
                                        <td class='col-md-1 pad_8'><button type="button"
                                                id="itinerary<?php echo $count; ?>" class="btn btn-info btn-iti btn-sm"
                                                title="Add Itinerary" style="border: none !important;"
                                                onClick="add_itinerary('dest_name_u','special_attaraction<?php echo $count; ?>-u','day_program<?php echo $count; ?>-u','overnight_stay<?php echo $count; ?>-u','Day-<?= $count ?>')"><i
                                                    class="fa fa-plus"></i></button>
                                        </td>
                                        <td class="hidden"><input type="text"
                                                value="<?php echo $sq_pckg1['entry_id']; ?>"></td>
                                    </tr>
                                    <?php $count++;
                                    }  ?>
                                </table>
                            ...
                            <div class="bg_white main_block panel-default-inner">
                                ...
                                <table id="tbl_package_hotel_master" name="tbl_package_hotel_master"
                                    ...
                                    <tr>
                                        ...
                                        <td><select id="city_name" name="city_name1"
                                                onchange="hotel_name_list_load(this.id);"
                                                class="city_master_dropdown app_select2" style="width:100%"
                                                title="Select City Name">
                                            </select></td>
                                        <td><select id="hotel_name" name="hotel_name1"
                                                onchange="hotel_type_load(this.id);" style="width:100%"
                                                title="Select Hotel Name">
                                                <option value="">*Hotel Name</option>
                                            </select></td>
                                        <td><input type="text" id="hotel_type" name="hotel_type1"
                                                placeholder="*Hotel Category" title="Hotel Category" readonly></td>
                                        <td><input type="text" id="hotel_tota_days1"
                                                onchange="validate_balance(this.id)" name="hotel_tota_days1"
                                                placeholder="*Total Night" title="Total Night"></td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><input maxlength="15" value="<?php echo $count_hotel; ?>" type="text"
                                                name="no" placeholder="Sr. No." class="form-control" disabled /></td>
                                        <td><select id="city_name<?php echo $count_hotel; ?>-u" name="city_name1"
                                                onchange="hotel_name_list_load(this.id);"
                                                class="city_master_dropdown app_select2" style="width:100%"
                                                title="Select City Name">
                                        ...
                                        <td><select id="hotel_name<?php echo $count_hotel; ?>-u" name="hotel_name1"
                                                onchange="hotel_type_load(this.id);" style="width:100%"
                                                title="Select Hotel Name">
                                                <?php
                                        ...
                                        <td><input type="text" id="hotel_type<?php echo $count_hotel; ?>-u"
                                                name="hotel_type1" value="<?php echo $row_hotel['hotel_type']; ?>"
                                                placeholder="Hotel Category" title="Hotel Category" readonly></td>
                                        <td><input type="text" id="hotel_tota_days1"
                                                value="<?php echo $row_hotel['total_days']; ?>" name="hotel_tota_days1"
                                                placeholder="Total Night" onchange="validate_balance(this.id);"
                                                title="Total Night"></td>
                                        <td class="hidden"><input type="text"
                                                value="<?php echo $row_hotel['entry_id']; ?>">
                                        </td>
                                    </tr>
                                    <script type="text/javascript">
                                    city_lzloading('select[name^=city_name1]')
                  ...
                  destinationLoading('select[name^=drop_to]', 'Drop-off Location');"><i
                                ...
                                <table id="tbl_package_tour_transport" name="tbl_package_tour_transport"
                                    ...
                                    if ($sq_count == 0) { ?>
                                    <tr>
                                        <td><input class="css-checkbox labelauty" id="chk_transport1" type="checkbox"
                                                autocomplete="off" data-original-title="" title="" aria-hidden="true"
                                                style="display: none;"><label for="chk_transport1"><span
                                                    class="labelauty-unchecked-image"></span><span
                                                    class="labelauty-checked-image"></span></label><label
                                                class="css-label" for="chk_transport1"> </label></td>
                                        <td class="col-md-1"><input maxlength="15" value="1" type="text" name="username"
                                                placeholder="Sr No." class="form-control" disabled="" autocomplete="off"
                                                data-original-title="" title=""></td>
                                        <td class="col-md-3"><select name="vehicle_name1" id="vehicle_name1"
                                        ...
                                        <td class="col-md-3"><select name="pickup_from" id="pickup_from"
                                                data-toggle="tooltip" style="width:250px;" title="Pickup Location"
                                                class="form-control app_minselect2 pickup_from_u">
                                                </optgroup>
                                            </select></td>
                                        <td class="col-md-3"><select name="drop_to" id="drop_to" style="width:250px;"
                                                data-toggle="tooltip" title="Drop-off Location"
                                                class="form-control app_minselect2 drop_to_u">
                                            </select></td>
                                    </tr>
                                    <?php } else {
                                        $count_hotel = 0;
                                        ...
                                        ?>
                                    <tr>
                                        <td><input id="chk_transport1<?php echo $count_hotel; ?>-u" type="checkbox"
                                                checked>
                                        </td>
                                        <td><input maxlength="15" value="<?php echo $count_hotel; ?>" type="text"
                                                name="no" placeholder="Sr. No." class="form-control" disabled /></td>
                                        <td class="col-md-3"><select name="vehicle_name1-u"
                                                id="vehicle_name1<?php echo $count_hotel; ?>-u" style="width:250px"
                                                class="form-control app_select2" title="Select Vehicle">
                                        ...
                                        <td class="col-md-3"><select name="pickup_from<?php echo $count_hotel; ?>-u"
                                                id="pickup_from<?php echo $count_hotel; ?>-u" data-toggle="tooltip"
                                        ...
                                        <td class="col-md-3"><select name="drop_to<?php echo $count_hotel; ?>-u"
                                                id="drop_to<?php echo $count_hotel; ?>-u" style="width:250px;"
                                                data-toggle="tooltip" title="Drop-off Location"
                                                class="form-control app_minselect2 drop_to_u">
                                                <?php
                                                        // Drop
                                                        ...
                                                        ?>
                                        <td class="hidden"><input type="text"
                                                value="<?php echo $row_tr['entry_id']; ?>">
                                        </td>
                                    </tr>
                                    <script type="text/javascript">
                            ...
                            <div class="row mg_tp_20 mg_bt_20">
                                <div class="col-md-12 col-sm-6 mg_bt_10_sm_xs">
                                    <textarea class="form-control" id="note1" name="note1" placeholder="Note"
                                        title="Note" rows="2"><?= $sq_pckg['note'] ?></textarea>
                                </div>
                            </div>
                            <div class="row mg_bt_20">
                                <div class="col-md-6 col-sm-6 mg_bt_10_sm_xs">
                                    <h3 class="editor_title">Inclusions</h3>
                                    <textarea class="feature_editor" id="inclusions1" name="inclusions1"
                                        placeholder="Inclusions" rows="4" cols="10"
                                        title="Inclusions"><?php echo $sq_pckg['inclusions']; ?></textarea>
                                </div>
                                <div class="col-md-6 col-sm-6">
                                    <h3 class="editor_title">Exclusions</h3>
                                    <textarea class="feature_editor" id="exclusions1" name="exclusions1"
                                        placeholder="Exclusions" rows="4"
                                        title="Exclusions"><?php echo $sq_pckg['exclusions']; ?></textarea>
                                </div>
                            </div>
