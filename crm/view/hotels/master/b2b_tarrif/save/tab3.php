                        ...
                        <div class="col-md-12 text-right text_center_xs">
                            <div class="col-md-6 text-left">
                                <button type="button" class="btn btn-sm btnType st-custBtn"
                                    onclick="display_format_modal1();" data-toggle="tooltip" title="Download CSV"><i
                                        class="icon fa fa-download"></i>CSV Format</button>
                            ...
                            <button type="button" class="btn btn-info btn-sm ico_left"
                                onClick="addRow('table_hotel_weekend_tarrif','4')"><i
                                    class="fa fa-plus"></i>&nbsp;&nbsp;Add</button>
                            <button type="button" class="btn btn-danger btn-sm ico_left"
                                onClick="deleteRow('table_hotel_weekend_tarrif','4')"><i
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="table-responsive">
                                <table id="table_hotel_weekend_tarrif" name="table_hotel_weekend_tarrif"
                                    class="table table-bordered no-marg pd_bt_51" style="min-width:1500px">
                                    <tr>
                                        <td><input class="css-checkbox" id="chk_ticket3" type="checkbox"><label
                                        ...
                                        <td><select name="room_cat2" id="room_cat2" style="width:145px;"
                                                title="Room Category"
                                        ...
                                        <td><select name="day" id="day" style="width:150px;" title="Weekend Day"
                                        ...
                                        <td style='display:none;'><input type="text" id="second_child"
                                                ...
                                                onchange="validate_balance(this.id)" style="width: 110px;" /></td>
                                        ...
                                        <td><input type="text" id="markup_per" name="markup_per" placeholder="Markup(%)"
                                                ...
                                                style="width: 120px;" /></td>
                                        <td><input type="text" id="flat_markup" name="flat_markup" placeholder="Markup"
                                                title="Markup" onchange="validate_balance(this.id)"
                                                style="width: 120px;" />
                                        </td>
