                ...
                <div class="panel panel-default panel-body app_panel_style feildset-panel mg_tp_20">
                    ...
                    <div class="row mg_bt_10">
                        <div class="col-md-3 col-sm-6 col-xs-12">
                            <select id="cmb_city_id1" name="cmb_city_id1" onchange="hotel_name_list_load(this.id)"
                                class="city_master_dropdown" style="width:100%" title="Select City Name" required>
                            </select>
                        </div>
                        <div class="col-md-3 col-sm-6 col-xs-12">
                    ...
                    <div class="row mg_bt_10">
                        <div class="col-md-12 text-right text_center_xs">
                            <div class="col-md-6 text-left">
                                <button type="button" class="btn btn-sm btnType st-custBtn" onclick="seasonal_csv();"
                                    data-toggle="tooltip" title="Download CSV"><i class="icon fa fa-download"></i>CSV
                                    Format</button>

                                <div class="div-upload  mg_bt_20" data-toggle="tooltip" title="Upload CSV"
                                    id="div_upload_button1">
                            ...
                            <button type="button" class="btn btn-info btn-sm ico_left"
                                onClick="addRow('table_hotel_tarrif1','1')"><i
                                    class="fa fa-plus"></i>&nbsp;&nbsp;Add</button>
                            <button type="button" class="btn btn-danger btn-sm ico_left"
                                onClick="deleteRow('table_hotel_tarrif1','1')"><i
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="table-responsive">
                                <table id="table_hotel_tarrif1" name="table_hotel_tarrif"
