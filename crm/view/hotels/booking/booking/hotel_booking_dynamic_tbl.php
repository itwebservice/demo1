<tr>
    ...
    <td><select id="hotel_id1" name="hotel_id1" title="Hotel" style="width:130px"
            onchange="get_auto_values('booking_date','sub_total','payment_mode','service_charge','markup','save','true','service_charge','discount');"
            data-toggle="tooltip">
    ...
    <td><input type="text" data-toggle="tooltip" style="width:150px;" class="app_datetimepicker"
            ...
            onchange="get_to_datetime(this.id,'check_out<?= $prefix ?>1');calculate_total_nights('check_in<?= $prefix ?>1', 'check_out<?= $prefix ?>1','no_of_nights<?= $prefix ?>1')">
    </td>
    <td><input type="text" data-toggle="tooltip" style="width:150px;" class="app_datetimepicker"
            id="check_out<?= $prefix ?>1" name="check_out<?= $prefix ?>1" placeholder="Check-Out Date Time"
            title="Check-Out Date Time"
            onchange="calculate_total_nights('check_in<?= $prefix ?>1', 'check_out<?= $prefix ?>1','no_of_nights<?= $prefix ?>1')"
    ...
    <td><input type="text" data-toggle="tooltip" style="width:120px;" id="no_of_nights<?= $prefix ?>1"
            ...
            onchange="get_auto_values('booking_date','sub_total','payment_mode','service_charge','markup','save','true','service_charge','discount');validate_balance(this.id)">
    </td>
