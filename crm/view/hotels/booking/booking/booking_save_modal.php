                ...
                <form id="frm_hotel_booking_save">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <select name="quotation_id" id="quotation_id" style="width:100%"
                                    onchange="get_quotation_details(this)" class="form-control text-center">
                    ...
                    <div class="panel panel-default panel-body app_panel_style feildset-panel">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3 col-xs-12 mg_bt_10">
                                <input type="text" id="adults" name="adults" placeholder="Adult(s)" title="Adult(s)"
                                    onchange="validate_balance(this.id);get_auto_values('booking_date','sub_total','payment_mode','service_charge','markup','save','true','service_charge','discount',true);">
                            </div>
                            <div class="col-sm-3 col-xs-12 mg_bt_10">
                                <input type="text" id="childrens" name="childrens" placeholder="Child(ren)"
                                    title="Child(ren)"
                                    onchange="validate_balance(this.id);get_auto_values('booking_date','sub_total','payment_mode','service_charge','markup','save','true','service_charge','discount',true)">
                            </div>
                            <div class="col-sm-3 col-xs-12 mg_bt_10">
                                <input type="text" id="infants" name="infants" placeholder="Infant(s)" title="Infant(s)"
                                    ...
                                    success: function(result) {
                                        ...
                                        if (msg[0] == 'error') {
                                            ...
                                            $('#btn_hotel_booking')
                                                .button('reset');
                                            reset_form(
                                                'frm_hotel_booking_save'
                                            );
                                            booking_list_reflect();
                                            msg_popup_reload(msg1[0]);
                                            window.open(base_url +
                                                'view/vendor/dashboard/estimate/estimate_save_modal.php?type=Hotel Booking&amount=' +
                                                sub_total +
                                                '&booking_id=' +
                                                msg1[1]);
                                            setTimeout(() => {
