                ...
                <div class="modal-body">
                  ...
                  ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3 col-xs-12 mg_bt_10_sm_xs">
                                <input type="text" id="childrens1" name="childrens1" placeholder="Child(ren)"
                                    title="Child(ren)" value="<?= $sq_booking['childrens'] ?>"
                                    onchange="get_auto_values('booking_date1','sub_total1','payment_mode','service_charge1','markup1','update','true','discount1',true);validate_balance(this.id)">
                            </div>
                            <div class="col-sm-3 col-xs-12 mg_bt_10_sm_xs">
                    ...
                    ?>
                              ...
                              ?>
                                                    <option value="<?php echo $sq_hotel['hotel_id'] ?>">
                                                        <?php echo $sq_hotel['hotel_name'] ?></option>
                                                </select>
                                            </td>
                                        ...
                                        <script>
                                        $('#check_in<?= $prefix . $count ?>_f, #check_out<?= $prefix . $count ?>_f')
                                            .datetimepicker({
                                                format: 'd-m-Y H:i'
                                            });
                                        </script>
