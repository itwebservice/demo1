<tr>
    ...
    <td><input type="text" style="width:200px" id="exc_date-<?= $offset ?>1" name="exc_date-<?= $offset ?>1"
            ...
            value="<?= date('d-m-Y H:i') ?>" style="width:110px" onchange="get_excursion_amount();"></td>
    ...
    <td><select id="excursion-<?= $offset ?>1" class="app_select2 form-control" title="Activity Name"
            name="excursion-<?= $offset ?>1" onchange="get_excursion_amount();" style="width:160px">
    ...
    <td><input class="form-control" type="text" id="total_adult-<?= $offset ?>1" name="total_adult-<?= $offset ?>1"
            ...
            onchange="excursion_amount_calculate(this.id);calculate_exc_expense('tbl_dynamic_exc_booking');validate_balance(this.id);get_auto_values('balance_date','exc_issue_amount','payment_mode','service_charge','markup','save','true','service_charge');"
            style="width:110px"></td>
    <td><input class="form-control" type="text" id="total_children-<?= $offset ?>1"
            name="total_children-<?= $offset ?>1" placeholder="*Total Child" title="Total Child"
            onchange="excursion_amount_calculate(this.id);calculate_exc_expense('tbl_dynamic_exc_booking');validate_balance(this.id);get_auto_values('balance_date','exc_issue_amount','payment_mode','service_charge','markup','save','true','service_charge');"
            style="width:110px"></td>
    <td><input class="form-control" type="text" id="adult_cost-<?= $offset ?>1" name="adult_cost-<?= $offset ?>1"
            placeholder="Adult Cost" title="Adult Cost"
            onchange="excursion_amount_calculate(this.id);calculate_exc_expense('tbl_dynamic_exc_booking');validate_balance(this.id)"
            style="width:110px"></td>
    <td><input class="form-control" type="text" id="child_cost-<?= $offset ?>1" name="child_cost-<?= $offset ?>1"
    ...
    <td><input class="form-control" type="text" id="total_amount-<?= $offset ?>1" name="total_amount-<?= $offset ?>1"
            placeholder="Total Amount" title="Activity Amount" onchange="validate_balance(this.id)" style="width:120px">
    </td>
</tr>
