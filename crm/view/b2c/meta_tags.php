...
<form id="section_meta_tags">
    <div class="row mg_bt_20">
        ...
        <div class="col-md-4">
            <a target="_blank" href="https://www.youtube.com/watch?v=ClXTdjsXKFU"
            ...
            <div class="table-responsive">
                <table id="tbl_meta_tags" name="tbl_meta_tags" class="table border_0 table-hover" style="width:1000px;">
                    ...
                    <tr>
                        ...
                        <td><select name="page-1" id="page-1" title="Select Page" class="form-control app_select2"
                        ...
                        <td><textarea id="title-1" name="title" title="*Title" placeholder="*Title"
                                onchange="validate_char_size('title-1',120);" rows="1"
                                style="width:120px; height:40px;"></textarea></td>
                        <td><textarea id="description-1" name="description" title="*Description"
                                placeholder="*Description" onchange="validate_char_size('description-1',200);" rows="1"
                                style="width:120px; height:40px;"></textarea></td>
                        <td><textarea id="keywords-1" name="keywords" title="*Keywords" placeholder="*Keywords"
                                onchange="validate_char_size('keywords-1',500);" rows="1"
                                style="width:120px; height:40px;"></textarea></td>
                    ...
                    <tr>
                        ...
                        <td><input maxlength="15" value="<?= $i ?>" type="text" name="no" placeholder="Sr. No."
                                class="form-control" disabled /></td>
                        <td><select name="page-1" id="page-1<?= $i ?>_u" title="Select Page"
                                class="form-control app_select2" style="width:150px" class="form-control">
                                <?php
                        ...
                        <td><textarea style="width:200px;" id="title-1<?= $i ?>_u" name="title" title="*Title"
                                placeholder="*Title" onchange="validate_char_size('title-1<?= $i ?>_u',120);"
                                rows="1"><?= $row_query['title'] ?></textarea></td>
                        <td><textarea style="width:200px;" id="description-1<?= $i ?>_u" name="description"
                                placeholder="*Description" title="*Description"
                                onchange="validate_char_size('description-1<?= $i ?>_u',200);"
                                rows="1"><?= $row_query['descriiption'] ?></textarea></td>
                        <td><textarea style="width:200px;" id="keywords-1<?= $i ?>_u" name="keywords"
                                placeholder="*Keywords" title="*Keywords"
                                onchange="validate_char_size('keywords-1<?= $i ?>_u',500);"
                                rows="1"><?= $row_query['keywords'] ?></textarea></td>
