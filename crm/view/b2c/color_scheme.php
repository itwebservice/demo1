...
<form id="section_color">
    ...
    <div class="row mg_bt_20">
        ...
        <div class="col-md-9">
            <a class="btn btn-info btn-sm ico_left" data-toggle="tooltip" data-placement="bottom" title="Setting"
                href="javascript:void(0)" onclick="color_scheme_save_modal('text_primary_color')"><i
    ...
    <div class="row mg_bt_20">
        ...
        <div class="col-md-9">
            <a class="btn btn-info btn-sm ico_left" data-toggle="tooltip" data-placement="bottom" title="Setting"
                href="javascript:void(0)" onclick="color_scheme_save_modal('text_secondary_color')"><i
                    class="fa fa-cog"></i><span class="">&nbsp;&nbsp;Change</span></a>
        </div>
    </div>
    <div class="row mg_bt_20">
        ...
        <div class="col-md-9">
            <a class="btn btn-info btn-sm ico_left" data-toggle="tooltip" data-placement="bottom" title="Setting"
                href="javascript:void(0)" onclick="color_scheme_save_modal('button_color')"><i
                    class="fa fa-cog"></i><span class="">&nbsp;&nbsp;Change</span></a>
        </div>
    </div>
