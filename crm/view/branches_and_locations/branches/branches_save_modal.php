            ...
            <div class="modal-content">
                ...
                ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4 mg_bt_10">
                            <select name="acc_name" id="acc_name" title="Account Type">
                        ...
                        <div class="col-sm-4 mg_bt_10">
                            <input type="text" id="bank_acc_no" name="bank_acc_no" placeholder="A/c No"
                                onchange="validate_accountNo(this.id)" title="A/c No">
                        </div>
                        <div class="col-sm-4 mg_bt_10">
                            <input type="text" id="bank_branch_name" onchange="validate_branch(this.id);"
                                name="bank_branch_name" placeholder="Branch Name" title="Branch Name">
                        </div>

                        <div class="col-sm-4 mg_bt_10">
                            <input type="text" id="bank_ifsc_code" onchange="validate_IFSC(this.id);"
                                name="bank_ifsc_code" placeholder="IFSC/SWIFT Code" title="IFSC/SWIFT Code"
                                style="text-transform: uppercase;">
                        </div>
                        <div class="col-sm-4 mg_bt_10">
                            <input type="text" id="branch_tax" name="branch_tax" placeholder="Branch Tax no."
                                title="Branch Tax no." style="text-transform: uppercase;">
                        </div>
                        <div class="col-sm-4 mg_bt_10">
                            <select name="active_flag" id="active_flag" title="Status" style="width:100%"
                                class="hidden">
