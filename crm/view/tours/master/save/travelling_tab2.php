                                        ...
                                        <div class="row mg_bt_10">
                                            <div class="col-md-12 text-right text_center_xs">
                                                <button type="button" class="btn btn-excel btn-sm"
                                                    onClick="addRow('tbl_group_tour_save_dynamic_train');city_lzloading('.trainfrom','*From',true);city_lzloading('.trainto','*To',true)"><i
                                                        class="fa fa-plus"></i></button>
                                                <button type="button" class="btn btn-pdf btn-sm"
                                                    onClick="deleteRow('tbl_group_tour_save_dynamic_train')"><i
                                        ...
                                        <div class="row mg_bt_10">
                                            <div class="col-md-12">
                                                <div class="table-responsive">
                                                    <table id="tbl_group_tour_save_dynamic_train"
                                                        name="tbl_group_tour_save_dynamic_train"
                                                        class="table table-bordered no-marg pd_bt_51">
                                                        <tr>
                                                            <td><input class="css-checkbox" id="chk_train1"
                                        ...
                                        <div class="row mg_bt_10">
                                            <div class="col-md-12 text-right text_center_xs">
                                                <button type="button" class="btn btn-info btn-sm ico_left"
                                                    title="Add Hotel" onclick="hotel_save_modal()"><i
                                                        class="fa fa-plus"></i>&nbsp;&nbsp;Hotel</button>
                                                <button type="button" class="btn btn-excel btn-sm"
                                                    onClick="addRow('tbl_package_hotel_master');city_lzloading('select[name^=city_name]')"><i
                                                        class="fa fa-plus"></i></button>
                                                <button type="button" class="btn btn-pdf btn-sm"
                                                ...
                                                <div class="table-responsive">
                                                    <table id="tbl_package_hotel_master" name="tbl_package_hotel_master"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input maxlength="15" value="1" type="text" name="no"
                                                                    placeholder="Sr. No." class="form-control"
                                                                    disabled /></td>
                                                            <td><select id="city_name" name="city_name1"
                                                                    onchange="hotel_name_list_load(this.id);"
                                                                    class="city_master_dropdown app_select2"
                                                                    style="width:100%" title="Select City Name">
                                                                </select></td>
                                                            <td class="col-md-4"><select id="hotel_name"
                                                                    name="hotel_name1"
                                                                    onchange="hotel_type_load(this.id);"
                                                                    style="width:100% !important"
                                                                    title="Select Hotel Name">
                                                                    <option value="">*Hotel Name</option>
                                                                </select></td>
                                                            <td class="col-md-4"><input type="text" id="hotel_type"
                                                                    name="hotel_type1" placeholder="*Hotel Category"
                                                                    title="Hotel Category" readonly></td>
                                                            <td class="col-md-4"><input type="text"
                                                                    id="hotel_tota_days1"
                                                                    onchange="validate_balance(this.id)"
                                                                    name="hotel_tota_days1" placeholder="*Total Night"
                                ...
                                <div id="collapse2" class="panel-collapse collapse main_block" role="tabpanel"
                                    ...
                                    <div class="panel-body">
                                        <div class="row mg_bt_10">
                                            <div class="col-md-12 text-right text_center_xs">
                                                <button type="button" class="btn btn-excel btn-sm"
                                                    onClick="addRow('tbl_group_tour_quotation_dynamic_plane');"><i
                                                        class="fa fa-plus"></i></button>
                                                <button type="button" class="btn btn-pdf btn-sm"
                                                    onClick="deleteRow('tbl_group_tour_quotation_dynamic_plane')"><i
                                                        class="fa fa-trash"></i></button>
                                            </div>
                                        </div>
                                        <div class="row mg_bt_10">
                                            <div class="col-md-12">
                                                <div class="table-responsive">
                                                    <table id="tbl_group_tour_quotation_dynamic_plane"
                                                        name="tbl_group_tour_quotation_dynamic_plane"
                                                        class="table table-bordered no-marg pd_bt_51">
                                                        <tr>
                                                            <td><input class="css-checkbox" id="chk_plan-"
                                                                    type="checkbox"><label class="css-label"
                                ...
                                <div id="collapse4" class="panel-collapse collapse main_block" role="tabpanel"
                                    ...
                                    <div class="panel-body">
                                        <div class="row mg_bt_10">
                                            <div class="col-md-12 text-right text_center_xs">
                                                <button type="button" class="btn btn-excel btn-sm"
                                                    onClick="addRow('tbl_dynamic_cruise')"><i
                                                        class="fa fa-plus"></i></button>
                                                <button type="button" class="btn btn-pdf btn-sm"
                                                    onClick="deleteRow('tbl_dynamic_cruise')"><i
                                                        class="fa fa-trash"></i></button>
                                            </div>
                                        </div>
                                        <div class="row mg_bt_10">
                                            <div class="col-md-12">
                                                <div class="table-responsive">
                                                    <table id="tbl_dynamic_cruise" name="tbl_dynamic_cruise"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input maxlength="15" value="1" type="text"
                                                                    name="username" placeholder="Sr. No."
                                                                    class="form-control" disabled /></td>
                                                            <td class="col-md-6"><input type="text" id="route"
                                                                    name="route"
                                                                    onchange="validate_specialChar(this.id);"
                                                                    placeholder="*Route" title="Route"></td>
                                                            <td class="col-md-6"><input type="text" id="cabin"
                                                                    name="cabin"
                                                                    onchange="validate_specialChar(this.id);"
                                                                    placeholder="Cabin" title="Cabin"></td>
                                                        </tr>
                                                    </table>
                                                </div>
                                            </div>
