        ...
        <div class="container">
            <div class="row text-center">
                ...
                <div class="col-md-3 col-sm-6 mg_bt_10_xs">
                    ...
                    <input type="text" id="txt_tour_cost" name="txt_tour_cost" onchange="validate_balance(this.id)"
                ...
                <div class="col-md-3 col-sm-6 mg_bt_10_xs">
                    ...
                    <input type="text" id="txt_child_with_cost" name="txt_child_with_cost"
                ...
                <div class="col-md-3 col-sm-6 mg_bt_10_xs">
                    ...
                    <input type="text" id="txt_child_without_cost" name="txt_child_without_cost"
            ...
            <div class="row mg_tp_10 text-center">
                <div class="col-md-3 col-sm-6 mg_bt_10_xs">
                    <input type="text" id="with_bed_cost" onchange="validate_balance(this.id)"
