...
<div class="panel panel-default panel-body">
    ...
    ?>
        <div class="row mg_tp_20">
            ...
            <div class="col-md-2">
                <input type="text" name="issue_date" id="issue_date" title="Issue Date" class="form-control"
                    value="<?= ($sq_traveler_info['passport_issue_date']) == "1970-01-01" ? date('d-m-Y') : get_date_user($sq_traveler_info['passport_issue_date']) ?>"
                    placeholder="Issue Date" title="Issue Date" onchange="get_to_date(this.id,'expiry_date');">
            </div>
            <div class="col-md-2">
                <input type="text" name="expiry_date" id="expiry_date" title="Expiry Date" class="form-control"
                    value="<?= ($sq_traveler_info['passport_expiry_date']) == "1970-01-01" ? date('d-m-Y') : get_date_user($sq_traveler_info['passport_expiry_date']) ?>"
            ...
            <div class="col-md-3 col-sm-6 text_left_xs">
                ...
                <div class="col-md-2 col-sm-6 text_left_xs">
                    ...
                    <a href="<?= $download_url ?>" class="btn btn-info btn-sm ico_left" title="Download ID Proof"
                        style="padding: 15px 24px;" download><i class="fa fa-download"></i></a>
                    <?php endif; ?>
                </div>
            </div>
            ...
            <div class="col-md-3 col-sm-6 text_left_xs">
                ...
                <div class="col-md-2 col-sm-6 text_left_xs">
                    ...
                    <a href="<?= $download_urlpan_card ?>" class="btn btn-info btn-sm ico_left"
                        title="Download ID Proof-2" style="padding: 15px 24px;" download><i
        ...
        <div class="row mg_tp_10">
            <div class="col-md-offset-8"><span class="note">(Note size : upto 5MB. Only pdf, jpg, png files)</span>
            </div>
        </div>
        <div class="row mg_tp_20">
