                ...
                <form id="frm_customer_update">
                    ...
                    <div class="row mg_bt_20">
                        <div class="col-md-4 col-md-offset-2">
                            <select name="cust_type" id="cust_type" onchange="corporate_fields_reflect();"
                                title="Customer Type">
                        ...
                        <div class="col-md-4">
                            <select name="cust_source" id="cust_source" class="form-control" data-toggle="tooltip"
                                onchange="corporate_fields_reflect();" title="Customer Source">
                        ...
                        <div class="row">
                            <div class="col-sm-4 col-xs-12">
                                <input type="text" id="cust_pan1" name="cust_pan1"
                                    ...
                                    placeholder="PAN/TAN No" title="PAN/TAN No" style="text-transform: uppercase;">
                            </div>
                            <div class="col-sm-4 col-xs-12">
