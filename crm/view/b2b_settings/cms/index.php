...
<div class="div_left type-02">
  ...
  <ul class="nav nav-pills" id="index_page">
    ...
    <li role="presentation" class="dropdown">
      <a><i class="fa fa-user-o" aria-hidden="true"></i> 1- Banner Images</a>
    </li>
    <li role="presentation" class="dropdown">
      <a><i class="fa fa-bell-o" aria-hidden="true"></i> 2- Why Choose Us ?</a>
    </li>
    <li role="presentation" class="dropdown">
      <a><i class="fa fa-eye" aria-hidden="true"></i> 3- Amazing Destination Ideas for you!</a>
    </li>
    <li role="presentation" class="dropdown">
      <a><i class="fa fa-lock" aria-hidden="true"></i> 4- Popular Destinations</a>
    </li>
    <li role="presentation" class="dropdown">
      <a><i class="fa fa-headphones" aria-hidden="true"></i> 5- Popular Hotels for Honeymoon</a>
    </li>
    <li role="presentation" class="dropdown">
      <a><i class="fa fa-database" aria-hidden="true"></i> 6- Popular Activities</a>
    </li>
    <li role="presentation" class="dropdown">
      <a><i class="fa fa-phone" aria-hidden="true"></i> 7- Call To Action</a>
    </li>
    <li role="presentation" class="dropdown">
      <a><i class="fa fa-question-circle" aria-hidden="true"></i> 8- Popular Hotels</a>
    </li>
    <li role="presentation" class="dropdown">
      <a><i class="fa fa-h-square" aria-hidden="true"></i> 9- Popular Destinations for Honeymoon</a>
    </li>
    <li role="presentation" class="dropdown">
