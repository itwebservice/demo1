...
$(function(){
  $('#frm_update').validate({
    rules:{
			...
			op_balance1 : { required : true},
			balance_side1 : { required : true}
    },
    submitHandler:function(form){
        ...
        $.post( 
			...
			{ bank_id : bank_id, bank_name : bank_name,account_name : account_name, branch_name : branch_name, address : address, account_no : account_no, ifsc_code : ifsc_code, swift_code : swift_code, account_type : account_type, mobile_no : mobile_no, opening_balance : opening_balance,op_balance:op_balance,balance_side:balance_side, active_flag : active_flag },
			function(data) {
