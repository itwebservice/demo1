        ...
        <div class="col-md-12">
          ...
          <div class="print_info_block">
            <ul class="main_block">
              ...
              <li class="col-md-12 mg_tp_10 mg_bt_10"><span>TAX : </span><?= str_replace(',','',$name).$service_tax_amount_show[0].' '.number_format($service_tax_amount_show1 + $markupservice_tax_amount_show1 + $costDetails['roundoff'],2) ?></li>
