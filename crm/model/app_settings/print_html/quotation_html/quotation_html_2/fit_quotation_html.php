                        ...
                        <div class="detailBlock text-center">
                            ...
                            <div class="detailBlockContent">
                                <h3 class="contentValue">
                                    <?php echo ($sq_quotation['total_days'] - 1) . 'N/' . $sq_quotation['total_days'] . 'D' ?>
                                </h3>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row mg_bt_20">
                            ...
                            <div class="col-md-4 text-center">
                                ...
                                <h4 class="no-marg"><?= ($bank_branch_name != '') ? $bank_branch_name : 'NA' ?>
                                    (<?= ($bank_ifsc_code != '') ? $bank_ifsc_code : 'NA' ?>) </h4>
                                <p>BRANCH</p>
                            </div>
                            <div class="col-md-4 text-center">
