...
public function bank_master_save()
{
	...
	$sq_bank = mysqlQuery("insert into bank_master (bank_id, bank_name,account_name, branch_name, address, account_no, ifsc_code, swift_code, account_type, mobile_no, op_balance,active_flag, created_at,balance_side) values ('$bank_id', '$bank_name', '$account_name','$branch_name', '$address', '$account_no', '$ifsc_code', '$swift_code', '$account_type', '$mobile_no', '$op_balance', '$active_flag', '$created_at','$balance_side')");
