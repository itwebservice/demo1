...
public function payment_master_delete(){
  ...
  $payment_date1 = $sq_package_payment['payment_date']; 
...
//////////////////////////////////**Payment notification message send start**/////////////////////////////////////
 ...
 public function payment_email_notification_send($tourwise_traveler_id, $payment_amount, $payment_mode, $payment_date, $payment_id)
 {
    ...
    $sq_tourwise = mysqli_fetch_assoc(mysqlQuery("select id,traveler_group_id,total_travel_expense, customer_id, net_total,form_date,currency_code,tour_group_status from tourwise_traveler_details where id='$tourwise_traveler_id'"));
...
//////////////////////////////////** Advance Payment email notification send start**/////////////////////////////////////
 ...
 public function whatsapp_send(){
	global $app_contact_no,$session_emp_id,$currency,$encrypt_decrypt, $secret_key;
