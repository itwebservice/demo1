...
$total_sale_amount = $group_amount + $package_amount + $visa_amount + $passport_amount + $air_amount + $train_amount + $bus_amount + $car_amount + $forex_amount + $hotel_amount + $exc_amount + $misc_amount;
